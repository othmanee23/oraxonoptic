        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6">
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              d'utilisation du service OpticAxon, une solution de gestion destinée aux opticiens et professionnels de l'optique.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              L'accès au service OpticAxon nécessite la création d'un compte utilisateur. L'utilisateur s'engage à fournir 
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              L'ensemble des éléments constituant le service OpticAxon (logiciel, design, textes, images) sont 
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              OpticAxon s'efforce d'assurer la disponibilité et la fiabilité du service. Cependant, nous ne pouvons 
